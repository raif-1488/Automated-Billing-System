...
//If you are logged in as an admin and you want to allow access to the forgot-password.php page, ensure that there are no session checks on that page that prevent access. If you have session checks on forgot-password.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($newPassword) || empty($confirmPassword)) {
        ...
        if ($admin) {
            ...
            $message = '<p class="error">No admin found with this email.</p>';
        }
    }
}
?>
